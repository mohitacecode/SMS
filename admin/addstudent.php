...
<form method="post" action="addstudent.php" enctype="multipart/form-data">
	<table border="1"  style="line-height: 140%; width: 100%; color:black; text-align: center;font-style: italic;" >
		...
		<tr>
			<td>Mobile No.</td>
			<td><input type="tel" name="mobile" placeholder="Enter Mobile Number" pattern="[0-9]{3}[0-9]{4}[0-9]{3}" required/> </td>
		</tr>
		<tr>
			<td>Parents Mobile No.</td>
			<td><input type="tel" name="parentNumber" placeholder="Enter Parents Mobile" required pattern="[0-9]{3}[0-9]{4}[0-9]{3}"/> </td>
		</tr>
		<tr>
			<td>Email-Id</td>
